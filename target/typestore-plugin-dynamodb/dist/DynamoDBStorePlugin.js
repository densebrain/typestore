...
var DynamoDBMessages_1 = require("./DynamoDBMessages");
...
var DynamoDBStorePlugin = function () {
    /**
     * Create new dynamodbstore
     */

    function DynamoDBStorePlugin() {
        var opts = arguments.length <= 0 || arguments[0] === undefined ? {} : arguments[0];

        _classCallCheck(this, DynamoDBStorePlugin);
    ...
    _createClass(DynamoDBStorePlugin, [{
        key: 'handle',
        ...
        value: function attributeType(attr) {
            ...
            attr.awsAttrType = DynamoDBUtil_1.typeToDynamoType(type, attr.typeName);
        ...
        value: function tableDefinition(clazzName) {
            ...
            modelOptions.attrs.forEach(function (attr) {
                ...
                if (attr.primaryKey || attr.secondaryKey) {
                    ...
                    if (attr.primaryKey && attr.secondaryKey) assert(DynamoDBMessages_1.msg(DynamoDBMessages_1.Strings.ManagerOnlyOneKeyType, attr.name));
                    keySchema.push({
                        AttributeName: attr.name,
                ...
                return regeneratorRuntime.wrap(function _callee2$(_context2) {
                    while (1) {
                        switch (_context2.prev = _context2.next) {
                            case 0:
                                _context2.next = 2;
                                return this.dynamoClient.waitFor(DynamoDBTypes_1.ResourceState[resourceState], DynamoDBUtil_1.tableNameParam(TableName)).promise();
                    ...
                    while (1) {
                        switch (_context4.prev = _context4.next) {
                            ...
                            case 4:
                                ...
                                if (!DynamoDBUtil_1.isTableStatusIn(status, DynamoDBTypes_1.TableStatus.DELETING)) {
                                    _context4.next = 8;
                                    break;
                                }

                                throw new Error(DynamoDBMessages_1.msg(DynamoDBMessages_1.DynamoStrings.TableDeleting, tableDef.TableName));

                            case 8:
                                if (!DynamoDBUtil_1.isTableStatusIn.apply(DynamoDBUtil_1, [status].concat(_toConsumableArray(DynamoDBTypes_1.StatusPending)))) {
                                    _context4.next = 12;
                                    break;
                                }
                    ...
                    while (1) {
                        switch (_context7.prev = _context7.next) {
                            ...
                            case 4:
                                ...
                                if (!(tableInfo && this.coordinatorOpts.syncStrategy === typestore_1.SyncStrategy.Overwrite)) {
                                    _context7.next = 11;
                                    break;
                                }
                            ...
                            case 15:
                                if (!DynamoDBUtil_1.isTableStatusIn.apply(DynamoDBUtil_1, [DynamoDBTypes_1.TableStatus[tableInfo.TableStatus]].concat(_toConsumableArray(DynamoDBTypes_1.StatusPending)))) {
                                    _context7.next = 20;
                                    break;
                                }
                        ...
                        switch (_context9.prev = _context9.next) {
                            case 0:
                                ...
                                tableDefs = models.map(function (modelType) {
                                    return _this2.tableDefinition(modelType.name);
                                });
    ...
    return DynamoDBStorePlugin;
}();

exports.DynamoDBStorePlugin = DynamoDBStorePlugin;
//# sourceMappingURL=DynamoDBStorePlugin.js.map
