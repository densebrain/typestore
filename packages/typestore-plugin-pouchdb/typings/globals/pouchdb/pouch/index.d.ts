...
interface PouchApi {
	...
	allDocs(opts?: PouchAllDocsOptions, callback?: (err: PouchError, res: PouchAllDocsResponse) => void): Promise<any>;
	allDocs(callback?: (err: PouchError, res: PouchAllDocsResponse) => void): Promise<any>;
}
...
interface PouchApi {
	bulkDocs(req: any[], opts?: PouchUpdateOptions, callback?: (err: PouchError, res: PouchUpdateResponse[]) => void): Promise<any>;
	bulkDocs(req: any[], callback?: (err: PouchError, res: PouchUpdateResponse[]) => void): Promise<any>;
	//
	// post == insert (doc does not contain an _id)
	//
	post(doc: any, opts?: PouchUpdateOptions, callback?: (err: PouchError, res: PouchUpdateResponse) => void): Promise<any>;
	post(doc: any, callback?: (err: PouchError, res: PouchUpdateResponse) => void): Promise<any>;
	//
	// put == update (doc DOES contain an _id)
	//
	put(doc: any, opts?: PouchUpdateOptions, callback?: (err: PouchError, res: PouchUpdateResponse) => void): Promise<any>;
	put(doc: any, callback?: (err: PouchError, res: PouchUpdateResponse) => void): Promise<any>;
	//
	// remove == delete
	//
	remove(doc: any, opts?: PouchUpdateOptions, callback?: (err: PouchError, res: PouchUpdateResponse) => void): Promise<any>;
	remove(doc: any, callback?: (err: PouchError, res: PouchUpdateResponse) => void): Promise<any>;
}
