...
var DynoModelKey = typestore_1.Constants.DynoModelKey, DynoAttrKey = typestore_1.Constants.DynoAttrKey;
...
describe('#store-dynamodb', function () {
    ...
    it('#tableDef', function () {
        new Fixtures.Test1();
        var modelOpts = typestore_1.Manager.findModelOptionsByClazz(Fixtures.Test1);
